...
public class Address extends TableImpl<AddressRecord> {
    ...
    /**
     * The reference instance of <code>app_db.address</code>
     */
    ...
    /**
     * The column <code>app_db.address.id</code>.
     */
    public final TableField<AddressRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>app_db.address.cep_code</code>.
     */
    public final TableField<AddressRecord, String> CEP_CODE = createField(DSL.name("cep_code"), SQLDataType.VARCHAR(8), this, "");

    /**
     * The column <code>app_db.address.country</code>.
     */
    public final TableField<AddressRecord, String> COUNTRY = createField(DSL.name("country"), SQLDataType.VARCHAR(60).nullable(false), this, "");

    /**
     * The column <code>app_db.address.city</code>.
     */
    public final TableField<AddressRecord, String> CITY = createField(DSL.name("city"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>app_db.address.state</code>.
     */
    public final TableField<AddressRecord, String> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>app_db.address.neighborhood</code>.
     */
    public final TableField<AddressRecord, String> NEIGHBORHOOD = createField(DSL.name("neighborhood"), SQLDataType.VARCHAR(50), this, "");

    /**
     * The column <code>app_db.address.street</code>.
     */
    public final TableField<AddressRecord, String> STREET = createField(DSL.name("street"), SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>app_db.address.number</code>.
     */
    public final TableField<AddressRecord, Integer> NUMBER = createField(DSL.name("number"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>app_db.address.complement</code>.
     */
    public final TableField<AddressRecord, String> COMPLEMENT = createField(DSL.name("complement"), SQLDataType.VARCHAR(100), this, "");
    ...
    /**
     * Create an aliased <code>app_db.address</code> table reference
     */
    ...
    /**
     * Create a <code>app_db.address</code> table reference
     */
    public Address() {
    ...
    public CompanyDepartmentAddressPath companyDepartmentAddress() {
        if (_companyDepartmentAddress == null)
            _companyDepartmentAddress = new CompanyDepartmentAddressPath(this, null, Keys.COMPANY_DEPARTMENT_ADDRESS__FK_ADDRESS.getInverseKey());
