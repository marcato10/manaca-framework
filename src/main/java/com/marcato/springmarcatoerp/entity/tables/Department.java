...
public class Department extends TableImpl<DepartmentRecord> {
    ...
    /**
     * The reference instance of <code>app_db.department</code>
     */
    ...
    /**
     * The column <code>app_db.department.id</code>.
     */
    public final TableField<DepartmentRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>app_db.department.name</code>.
     */
    public final TableField<DepartmentRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * The column <code>app_db.department.description</code>.
     */
    public final TableField<DepartmentRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(100).nullable(false), this, "");
    ...
    /**
     * Create an aliased <code>app_db.department</code> table reference
     */
    ...
    /**
     * Create a <code>app_db.department</code> table reference
     */
    public Department() {
    ...
    public CompanyDepartmentAddressPath companyDepartmentAddress() {
        if (_companyDepartmentAddress == null)
            _companyDepartmentAddress = new CompanyDepartmentAddressPath(this, null, Keys.COMPANY_DEPARTMENT_ADDRESS__FK_DEPARTMENT.getInverseKey());
